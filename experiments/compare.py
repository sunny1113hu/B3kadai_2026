...
def build_command(run_cfg, seed, python_exec):
    ...
    if run_type == "dqn_cartpole":
        ...
        args = [
            ...
            "--buffer_size", str(run_cfg.get("buffer_size", int(1e6))),
            ...
            "--exp_noise_init", str(run_cfg.get("exp_noise_init", run_cfg.get("exp_noise", 0.2))),
            "--exp_noise_end", str(run_cfg.get("exp_noise_end", run_cfg.get("exp_noise", 0.2))),
            "--noise_decay_steps", str(run_cfg.get("noise_decay_steps", run_cfg.get("max_train_steps", int(1e6)))),
